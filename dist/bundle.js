...
function APRCalculator(form) {
	...
	function printCalcValues(selector, calculatedValues) {
		...
		var htmlStr = '';
		htmlStr += '<table cellspacing="10">\t\t\t\t\t\t\t<tr><td> Daily Payment </td><td>$ ' + calculatedValues['dailyPayment'] + ' </td></tr>\t\t\t\t\t\t\t<tr><td> Daily Interest Rate </td><td> ' + calculatedValues['dailyInterestRate'] + ' %</td></tr>\t\t\t\t\t\t\t<tr><td> APR </td><td> ' + calculatedValues['APRCalculation'] + ' %</td></tr>\t\t\t\t\t\t\t<tr><td> Repaid in about </td><td> ' + calculatedValues['daysToRepay'] + ' days</td></tr>\t\t\t\t\t\t\t<tr><td> Total Financing Cost </td><td>$ ' + calculatedValues['financingCost'] + ' </td></tr>\t\t\t\t\t\t</table>';
